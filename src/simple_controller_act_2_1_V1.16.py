# ============================================================
# V1.16 — Webots Self-Driving Controller
# ============================================================
#
...
# BC — key B
# When False bc_evasion_model is never called; Phase 1 EVADING and Phase 0
# line-lost both hold the last angle instead of running inference.
BC_ENABLED = True
...
def main():
    global DEBUG_PANEL, ADAS_MONITOR_ENABLED, PID_ENABLED, BC_ENABLED, CIL_ENABLED
    speed = 0
    angle = 0.0
    brake = 0.0
    ...
    print("=" * 60)
    print("  Webots Self-Driving Controller — V1.16")
    print("=" * 60)
