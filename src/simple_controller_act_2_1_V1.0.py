...
def main():
    ...
    while robot.step() != -1:
        ...
        driver.setSteeringAngle(angle) #Controls driving angle 
        driver.setCruisingSpeed(speed) #Controls Speed and acceleration
...
if __name__ == "__main__":
    ...
    #(venv) PS D:\ML\Projects\Project_5_MR4010.10_Navegacion\MR4010.10_Navegacion> & "C:\Program Files\Webots\msys64\mingw64\bin\webots-controller.exe" .\src\simple_controller_act_2_1.py --stdout-redirect